...
def bootstrap(
    ...
    try:
        ...
        # Own the dup'd descriptor from bootstrap entry onward. This covers
        # config/app import failures before ``socket.socket(fileno=...)`` as
        # well as failures after reconstruction. The outer generated wrapper
        # acknowledges this close to the parent before the host thread exits,
        # preventing a stale numeric FD from being closed again after reuse.
