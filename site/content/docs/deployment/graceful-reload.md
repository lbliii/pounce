...
description: Zero-downtime code reloads via SIGHUP signal
draft: false
weight: 60
lang: en
type: doc
tags: [deployment, reload, zero-downtime, SIGHUP]
keywords: [graceful reload, zero-downtime, SIGHUP, rolling restart, worker drain]
category: how-to
---
...
- [Graceful Shutdown](./graceful-shutdown) — Clean shutdown behavior
- [Production Deployment](./production) — Full deployment guide
- [Observability](./observability) — Monitor reload events
