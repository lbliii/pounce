---
title: OpenTelemetry
description: Native distributed tracing with zero-config OTLP export
draft: false
weight: 80
lang: en
type: doc
tags: [deployment, observability, opentelemetry, tracing]
keywords: [opentelemetry, tracing, OTLP, jaeger, datadog, tempo, honeycomb, distributed tracing]
category: how-to
---
...
- **Span creation:** ~50us per request
...
- [Production Deployment](./production) — Production observability setup
