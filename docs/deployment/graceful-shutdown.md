...
See [OpenTelemetry Integration](./opentelemetry.md) for details.
...
- [Health Checks](../features/health-checks.md) — Built-in `/health` endpoint
- [OpenTelemetry](./opentelemetry.md) — Monitor shutdown metrics
- [Production Deployment](./production.md) — Complete production guide
- [Graceful Reload](../features/graceful-reload.md) — Zero-downtime code updates
